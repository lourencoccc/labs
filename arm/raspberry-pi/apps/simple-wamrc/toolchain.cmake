...
message(STATUS "*** ARM Raspberry PI toolchain file ***")
...
if (NOT $ENV{ARM_A7_COMPILER_DIR} STREQUAL "") 
    SET (toolchain_sdk_dir /home/joaolourenco/toolchain/raspberrypi/tools/arm-bcm2708/gcc-linaro-arm-linux-gnueabihf-raspbian/bin/)
endif ()

if (NOT $ENV{ARM_A7_SDKTARGETSYSROOT} STREQUAL "") 
    SET(SDKTARGETSYSROOT /home/joaolourenco/toolchain/raspberrypi/rootfs)
